(function(exports) {
   ...
   * @returns 
   */
  exports.identity = function (target) {
   ...
   * @returns 
   */
  exports.ortho = function(left, right, bottom, top, near, far, target) {
    target = target || new Float32Array(16);
   ...
   * @returns 
   */
  exports.multiply = function(next, prev, target) {
    target = target || new Float32Array(16);
    // 第一列
    var p00 = prev[0];
    var p10 = prev[1];
...
})(window['WebGLMatrix'] || (window['WebGLMatrix'] = {}));